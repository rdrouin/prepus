...
//        Connect1.insert_result(1, 2, 1,90,"test", 1,3,2,4);
    }
    public void insert_result(int doc_1, int doc_2,int methode, int pourcentage, String commentaire,int debut1, int fin1, int debut2, int fin2 ) {
        try {
